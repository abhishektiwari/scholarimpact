...
# Import commands
from .commands import extract, crawl, dashboard, generate
...
@click.option('--launch-dashboard/--no-dashboard', default=True, help='Launch dashboard after analysis')
@click.pass_context
def quick_start(ctx, scholar_id, openalex_email, output_dir, launch_dashboard):
    ...
    ctx.invoke(crawl.crawl_citations, 
