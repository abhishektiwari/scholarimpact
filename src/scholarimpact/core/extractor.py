...
class AuthorExtractor:
    ...
    def extract(self, author_id, max_papers=None, output_file=None, output_dir='data'):
        ...
        try:
            ...
            author = scholarly.fill(author, sections=['basics', 'indices', 'coauthors', 'publications'])
            ...
            logger.info(f"Successfully wrote author data with {len(results)} articles to {output_file}")
